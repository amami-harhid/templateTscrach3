export { bubbleTextArr, bubbleTextArr2, MessageCat1Say, MessageCat1Think, MessageCat2Say, MessageCat2Think, MessageByeBye, MessageTAIJYO, };
const bubbleTextArr = [
    "こんにちは。良い天気ですね",
...
const MessageByeBye = 'BUBBLE_BYE_SAY';
